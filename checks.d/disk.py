...
class Disk(AgentCheck):
    ...
    def collect_metrics_psutil(self):
        self._valid_disks = {}
        heroku_partitions = [psutil._common.sdiskpart(device='/dev/loop2', mountpoint='/', fstype='ext3', opts='ro,noatime,nodiratime,data=ordered'), psutil._common.sdiskpart(device='/dev/mapper/evg0-evol0', mountpoint='/app', fstype='ext4', opts='rw,noatime,nodiratime')]
        for part in heroku_partitions:
